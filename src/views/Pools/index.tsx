...
const Pools: React.FC = () => {
  ...
  chosenPools = sortPools(chosenPools).slice(0, numberOfPoolsVisible).filter((pool) => {
    return pool.poolCategory !== PoolCategory.SPECIAL && pool.poolCategory !== PoolCategory.FARMING
  })
