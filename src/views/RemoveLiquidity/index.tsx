...
import { Button, Text, AddIcon, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@loopstarter/special-uikit'
  ...
  function modalBottom() {
    return (
      <>
        ...
        <Button variant='four' disabled={!(approval === ApprovalState.APPROVED || signatureData !== null)} onClick={onRemove}>
          {t('Confirm')}
        </Button>
      </>
    )
        ...
        <CardBody>
          ...
          <Box position="relative" mt="16px">
            {!account ? (
              ...
              <RowBetween>
                <Button
                  variant={approval === ApprovalState.APPROVED || signatureData !== null ? 'success' : 'four'}
