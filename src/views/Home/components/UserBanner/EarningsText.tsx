...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DEFIY pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DEFIY pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DEFIY pool', data)
  }
