...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@defifarms/special-uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in DEFIY prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with DEFIY, win DEFIY if your numbers match')}
        </Text>
      </Flex>
