...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@defifarms/special-uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'DEFIY card' },
    { src: 'green', alt: 'Green DEFIY card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'DEFIY card' },
  ],
}
