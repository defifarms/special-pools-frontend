...
export const TopLeftCircle = (props) => (
  <svg width="207px" height="182px" {...props} viewBox="0 0 207 182" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BottomRightCircle = (props) => (
  <svg width="438px" height="384px" {...props} viewBox="0 0 438 384" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const TopRightCircle = (props) => (
  <svg width="184px" height="184px" {...props} viewBox="0 0 184 184" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BottomLeftCircle = (props) => (
  <svg width="103" height="103" {...props} viewBox="0 0 103 103" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const TopLeftCircleSM = (props: SVGProps<SVGSVGElement>) => (
  <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g opacity={0.9} filter="url(#filter0_b_841_1616)">
      <circle cx={26.5} cy={26.5} r={26.5} fill="#965BFF" fillOpacity={0.5} />
    </g>
    <defs>
      <filter
        id="filter0_b_841_1616"
        x={-64.794}
        y={-64.794}
        width={182.588}
        height={182.588}
      ...
      >
        <feFlood floodOpacity={0} result="BackgroundImageFix" />
        <feGaussianBlur in="BackgroundImage" stdDeviation={32.397} />
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_841_1616" />
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_841_1616" result="shape" />
      </filter>
    </defs>
  </svg>
)
...
export const TopRightCircleSM = (props: SVGProps<SVGSVGElement>) => (
  <svg width="65px" height="120px" viewBox="0 0 65 120" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g opacity={0.9} filter="url(#filter0_b_841_1608)">
      <circle cx={59.6105} cy={59.6105} r={59.6105} fill="#965BFF" fillOpacity={0.5} />
    </g>
    <defs>
      <filter
        id="filter0_b_841_1608"
        x={-64.794}
        y={-64.794}
        width={248.809}
        height={248.809}
      ...
      >
        <feFlood floodOpacity={0} result="BackgroundImageFix" />
        <feGaussianBlur in="BackgroundImage" stdDeviation={32.397} />
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_841_1608" />
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_841_1608" result="shape" />
      </filter>
    </defs>
  </svg>
)
...
export const BottomRightCircleSM = (props: SVGProps<SVGSVGElement>) => (
  <svg width="137px" height="220px" viewBox="0 0 137 220" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g opacity={0.9} filter="url(#filter0_b_841_1586)">
      <circle cx={151.801} cy={151.775} r={151.618} fill="#965BFF" fillOpacity={0.5} />
    </g>
    <defs>
      <filter
        id="filter0_b_841_1586"
        x={-64.6105}
        y={-64.6368}
        width={432.824}
        height={432.824}
      ...
      >
        <feFlood floodOpacity={0} result="BackgroundImageFix" />
        <feGaussianBlur in="BackgroundImage" stdDeviation={32.397} />
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_841_1586" />
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_841_1586" result="shape" />
      </filter>
    </defs>
  </svg>
)
