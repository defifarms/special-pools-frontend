...
import { Button, Text, Modal, useModal, InjectedModalProps, Link } from '@loopstarter/special-uikit'
...
const UnsupportedModal: React.FC<Props> = ({ currencies, onDismiss }) => {
  ...
  return (
    <Modal title="Unsupported Assets" maxWidth="600px" onDismiss={onDismiss}>
      <AutoColumn gap="lg">
        {tokens.map((token) => {
          return (
            token &&
